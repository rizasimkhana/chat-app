          ...
          <div className="text-center-mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                <MessageSquare className="size-9 text-primary bg-gray-800 p-2 rounded-sm"/>
              </div>
              ...
              <div className="form-control">
                ...
                <div className="relative w-full">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none" style={{ zIndex: 4 }}>
                   <User className="size-5 text-base-content/40"/>
                  </div>
                  <input type="text" 
                  className={`input input-bordered w-full pl-10`} 
                  placeholder="Enter Your FullName" value={formData.fullName} 
                ...
                <div className="form-control">
                  ...
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointers-events-none">
                      <Lock className="size-5 test-base-content/40"/>
                    </div>
                    <input 
